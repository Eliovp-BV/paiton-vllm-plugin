...
def run_benchmark(args):
    ...
    manifest = {"model": MODEL, "revision": REVISION, "backend": args.backend, "argv": sys.argv,
                "stock_weight_freezing": os.environ.get("STOCK_WEIGHT_FREEZING", "0") == "1", "stock_prepared_weights": os.environ.get("STOCK_PREPARE_WEIGHTS", "1") == "1", "suite": args.suite,
                "prompt_encoder_outputs": [9, 18, 27],
                "convolution_autotune": os.environ.get("STOCK_CONV_AUTOTUNE", "0") == "1",
                ...
                "versions": {n: importlib.metadata.version(n) for n in ("torch", "triton", "diffusers", "transformers", "sdnq", "accelerate", "huggingface-hub", "safetensors")},
