...
The measurements above qualify the advertised Wan/FastWan profiles. Alternative A14B settings use a different checkpoint and duration and are not part of these matched Paiton speedups.
