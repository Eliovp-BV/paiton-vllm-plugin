...
Upstream multilingual support is not equivalent to local multilingual meeting qualification. The main meeting evaluation is English. A supplementary FLEURS comparison used three read-speech clips each in English, German, French and Latin American Spanish: Parakeet WER was 4.11%, 4.84%, 5.83% and 2.94%; Whisper Turbo was 8.22%, 1.61%, 7.77% and 1.96%. The tiny sample supports a preliminary multilingual execution check, not a broad ranking or a qualified non-English summary workflow. Real regional accents, unfamiliar participant names and dense overlapping speech remain important limitations. Browser capture and the native Teams application require separate validation from exported-recording import.
