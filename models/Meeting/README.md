...
| Partial summary | Granite 4.2 3B (3.7B actual parameters) | Separate compact text helper; evidence-linked partial notes with limited semantic qualification |
