...
p=argparse.ArgumentParser();p.add_argument('--launcher',required=True);p.add_argument('--recording',required=True);p.add_argument('--output',required=True);p.add_argument('--repeats',type=int,default=3);a=p.parse_args()
